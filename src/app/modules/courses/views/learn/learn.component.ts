...
export class LearnComponent implements OnInit {
  // TODO: convert this into dinamic data that comes from the server
  course = {
    public: true,
    labels: [
      'finance',
  ...
  ngOnInit() {
    // TODO: Get course id from route param
    this.courseId = '5e1924a6e05ff40023656e8f';

    // TODO: Get course full populated from server
    // Service call here

    this.authenticatedUser = this.store.pipe(select(selectAuthUser));
    this.authenticatedUser.subscribe(user => {
      if (user) {
        ...
        if (purchasedCourse) {
          ...
          log('User progress', this.userProgress);
        }
      }
    });
    ...
    this.userProgress = [
      '5deffd28ef2fd3002404263f',
      '5df023246c985f0024febd91',
      '5df011486c985f0024febd90',
    ];
  }
